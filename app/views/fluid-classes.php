...
<html lang="en"
    ...
    <body class="layout-fluid layout-sticky-subnav">
        ...
        <div class="mdk-header-layout js-mdk-header-layout">
            ...
            <div id="header"
                ...
                <div class="mdk-header__content">
                    ...
                    <div class="navbar navbar-expand-sm navbar-main navbar-dark bg-dark pr-0 pr-0"
                         id="navbar"
                         data-primary>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div id="account_menu"
                                        ...
                                        <a class="dropdown-item"
                                           href="fluid-dashboard.html"><i class="material-icons">dvr</i> Dashboard</a>
                                        <a class="dropdown-item"
                                           href="fluid-profile.html"><i class="material-icons">account_circle</i> My profile</a>
                                        <a class="dropdown-item"
                                           href="fluid-edit-account.html"><i class="material-icons">edit</i> Edit account</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item"
                                           href="fluid-login.html"><i class="material-icons">exit_to_app</i> Logout</a>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <div class="navbar-collapse collapse"
                                ...
                                <ul class="nav navbar-nav">
                                    <li class="nav-item dropdown active">
                                        <a href="#"
                                           class="nav-link dropdown-toggle"
                                           data-toggle="dropdown">Dashboards</a>
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                               href="fluid-dashboard.html">Default</a>
                                            <a class="dropdown-item active"
                                               href="fluid-classes.php">Analytics</a>
                                            <a class="dropdown-item"
                                               href="fluid-staff.html">CRM/Staff</a>
                                            <a class="dropdown-item"
                                               href="fluid-ecommerce.html">E-commerce</a>
                                        </div>
                                    </li>
                                    <li class="nav-item dropdown">
                                        <a href="#"
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                               href="fluid-app-activities.html">Trello</a>
                                            <a class="dropdown-item"
                                               href="fluid-app-trello.html">Trello</a>
                                            <a class="dropdown-item"
                                               href="fluid-app-projects.html">Projects</a>
                                            <a class="dropdown-item"
                                               href="fluid-app-fullcalendar.html">Event Calendar</a>
                                            <a class="dropdown-item"
                                               href="fluid-app-chat.html">Chat</a>
                                            <a class="dropdown-item"
                                               href="fluid-app-email.html">Email</a>
                                            <div class="dropdown-divider"></div>
                                            <div class="dropdown-header">Education</div>
                                            <a class="dropdown-item"
                                               href="fluid-app-browse-courses.html">Browse Courses</a>
                                            <a class="dropdown-item"
                                               href="fluid-app-course.html">Course</a>
                                            <a class="dropdown-item"
                                               href="fluid-app-lesson.html">Lesson</a>
                                        </div>
                                    </li>
                                    <li class="nav-item dropdown">
                                        <a href="#"
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                               href="fluid-stories.html">Stories</a>
                                            <a class="dropdown-item"
                                               href="fluid-invoice.html">Invoice</a>
                                            <a class="dropdown-item"
                                               href="fluid-pricing.html">Pricing</a>
                                            <a class="dropdown-item"
                                               href="fluid-edit-account.html">Edit Account</a>
                                            <a class="dropdown-item"
                                               href="fluid-profile.html">Profile</a>
                                            <a class="dropdown-item"
                                               href="fluid-payout.html">Payout</a>
                                            <a class="dropdown-item"
                                               href="login.html">Login</a>
                                            <a class="dropdown-item"
                                               href="signup.html">Sign Up</a>
                                            <a class="dropdown-item"
                                               href="fluid-digital-product.html">Digital Product</a>
                                            <a class="dropdown-item d-flex align-items-center"
                                               href="fluid-product-listing.html">
                                                <span class="flex mr-2">Product Listing</span>
                                                <span class="badge badge-primary">NEW</span>
                                            </a>
                                            <a class="dropdown-item d-flex align-items-center"
                                               href="fluid-blank.html">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                               href="fluid-ui-buttons.html">Buttons</a>
                                            <a class="dropdown-item"
                                               href="fluid-ui-alerts.html">Alerts</a>
                                            <a class="dropdown-item"
                                               href="fluid-ui-avatars.html">Avatars</a>
                                            <a class="dropdown-item"
                                               href="fluid-ui-modals.html">Modals</a>
                                            <a class="dropdown-item"
                                               href="fluid-ui-charts.html">Charts</a>
                                            <a class="dropdown-item"
                                               href="fluid-ui-icons.html">Icons</a>
                                            <a class="dropdown-item"
                                               href="fluid-ui-forms.html">Forms</a>
                                            <a class="dropdown-item"
                                               href="fluid-ui-range-sliders.html">Range Sliders</a>
                                            <a class="dropdown-item"
                                               href="fluid-ui-datetime.html">Time &amp; Date</a>
                                            <a class="dropdown-item"
                                               href="fluid-ui-tables.html">Tables</a>
                                            <a class="dropdown-item"
                                               href="fluid-ui-tabs.html">Tabs</a>
                                            <a class="dropdown-item"
                                               href="fluid-ui-loaders.html">Loaders</a>
                                            <a class="dropdown-item"
                                               href="fluid-ui-drag.html">Drag &amp; Drop</a>
                                            <a class="dropdown-item"
                                               href="fluid-ui-pagination.html">Pagination</a>
                                            <a class="dropdown-item"
                                               href="fluid-ui-vector-maps.html">Vector Maps</a>
                                        </div>
                                    </li>
                                    <li class="nav-item dropdown">
                                        <a href="#"
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                               href="classes.php">Default</a>
                                            <a class="dropdown-item active"
                                               href="fluid-classes.php">Full Width Navs</a>
                                            <a class="dropdown-item"
                                               href="fixed-classes.php">Fixed Navs</a>
                                            <a class="dropdown-item"
                                               href="mini-classes.php">Mini Sidebar + Navs</a>
                                        </div>
                                    </li>
                                </ul>
                            </div>
        ...
        <!-- App Settings FAB -->
        <div id="app-settings">
            <app-settings layout-active="fluid"
                          :layout-location="{
      'default': 'classes.php',
                ...
                <div class="sidebar sidebar-light sidebar-left sidebar-p-t"
                    ...
                    <ul class="sidebar-menu">
                        <li class="sidebar-menu-item active open">
                            ...
                            <ul class="sidebar-submenu collapse show "
                                ...
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="fluid-staff.html">
                                        <span class="sidebar-menu-text">Staff</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="fluid-ecommerce.html">
                                        <span class="sidebar-menu-text">E-commerce</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="fluid-dashboard-quick-access.html">
                        ...
                        <li class="sidebar-menu-item">
                            ...
                            <ul class="sidebar-submenu collapse"
                                ...
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="fluid-app-trello.html">
                                        <span class="sidebar-menu-text">Trello</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="fluid-app-projects.html">
                                        <span class="sidebar-menu-text">Projects</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="fluid-app-fullcalendar.html">
                                        <span class="sidebar-menu-text">Event Calendar</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="fluid-app-chat.html">
                                        <span class="sidebar-menu-text">Chat</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="fluid-app-email.html">
                                ...
                                <li class="sidebar-menu-item ">
                                    ...
                                    <ul class="sidebar-submenu collapse "
                                        ...
                                        <li class="sidebar-menu-item ">
                                            <a class="sidebar-menu-button"
                                               href="fluid-app-browse-courses.html">
                                                <span class="sidebar-menu-text">Browse Courses</span>
                                            </a>
                                        </li>
                                        <li class="sidebar-menu-item ">
                                            <a class="sidebar-menu-button"
                                               href="fluid-app-course.html">
                                                <span class="sidebar-menu-text">Course</span>
                                            </a>
                                        </li>
                                        <li class="sidebar-menu-item ">
                                            <a class="sidebar-menu-button"
                                               href="fluid-app-lesson.html">
                        ...
                        <li class="sidebar-menu-item">
                            ...
                            <ul class="sidebar-submenu collapse"
                                ...
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="fluid-companies.html">
                                        <span class="sidebar-menu-text">Companies</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="fluid-stories.html">
                                        <span class="sidebar-menu-text">Stories</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="fluid-discussions.html">
                                        <span class="sidebar-menu-text">Discussions</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="fluid-invoice.html">
                                        <span class="sidebar-menu-text">Invoice</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="fluid-pricing.html">
                                        <span class="sidebar-menu-text">Pricing</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="fluid-edit-account.html">
                                ...
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="fluid-payout.html">
                                        <span class="sidebar-menu-text">Payout</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button"
                                       href="fluid-digital-product.html">
                    ...
                    <div class="sidebar-block p-0 mb-0">
                        <ul class="sidebar-menu"
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button"
                                   href="fluid-ui-range-sliders.html">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button"
                                   href="fluid-ui-vector-maps.html">
                    ...
                    <div class="d-flex align-items-center sidebar-p-a border-bottom sidebar-account">
                        ...
                        <div class="dropdown ml-auto">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item"
                                   href="fluid-dashboard.html">Dashboard</a>
                                <a class="dropdown-item"
                                   href="fluid-profile.html">My profile</a>
                                <a class="dropdown-item"
                                   href="fluid-edit-account.html">Edit account</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item"
                                   href="fluid-login.html">Logout</a>
                            </div>
                        </div>
                    </div>
