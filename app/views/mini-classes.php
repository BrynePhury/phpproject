                            ...
                            <div class="navbar-collapse collapse flex">
                                <ul class="nav navbar-nav">
                                    <li class="nav-item dropdown active">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                               href="mini-dashboard.html">Default</a>
                                            <a class="dropdown-item active"
                                               href="mini-classes.php">Analytics</a>
                                            <a class="dropdown-item"
                                               href="mini-staff.html">CRM/Staff</a>
                                            <a class="dropdown-item"
                                               href="mini-ecommerce.html">E-commerce</a>
                                        </div>
                                    </li>
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                               href="mini-app-activities.html">Trello</a>
                                            <a class="dropdown-item"
                                               href="mini-app-trello.html">Trello</a>
                                            <a class="dropdown-item"
                                               href="mini-app-projects.html">Projects</a>
                                            <a class="dropdown-item"
                                               href="mini-app-fullcalendar.html">Event Calendar</a>
                                            <a class="dropdown-item"
                                               href="mini-app-chat.html">Chat</a>
                                            <a class="dropdown-item"
                                               href="mini-app-email.html">Email</a>
                                            <div class="dropdown-divider"></div>
                                            <div class="dropdown-header">Education</div>
                                            <a class="dropdown-item"
                                               href="mini-app-browse-courses.html">Browse Courses</a>
                                            <a class="dropdown-item"
                                               href="mini-app-course.html">Course</a>
                                            <a class="dropdown-item"
                                               href="mini-app-lesson.html">Lesson</a>
                                        </div>
                                    </li>
                                    <li class="nav-item dropdown">
                                        <a href="#"
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                               href="mini-stories.html">Stories</a>
                                            <a class="dropdown-item"
                                               href="mini-invoice.html">Invoice</a>
                                            <a class="dropdown-item"
                                               href="mini-pricing.html">Pricing</a>
                                            <a class="dropdown-item"
                                               href="mini-edit-account.html">Edit Account</a>
                                            <a class="dropdown-item"
                                               href="mini-profile.html">Profile</a>
                                            <a class="dropdown-item"
                                               href="mini-payout.html">Payout</a>
                                            <a class="dropdown-item"
                                               href="login.html">Login</a>
                                            <a class="dropdown-item"
                                               href="signup.html">Sign Up</a>
                                            <a class="dropdown-item"
                                               href="mini-digital-product.html">Digital Product</a>
                                            <a class="dropdown-item d-flex align-items-center"
                                               href="mini-product-listing.html">
                                                <span class="flex mr-2">Product Listing</span>
                                                <span class="badge badge-primary">NEW</span>
                                            </a>
                                            <a class="dropdown-item d-flex align-items-center"
                                               href="mini-blank.html">
                            ...
                            <ul class="nav navbar-nav d-none d-sm-flex border-left navbar-height align-items-center">
                                <li class="nav-item dropdown">
                                    ...
                                    <div id="account_menu"
                                        ...
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item"
                                           href="mini-dashboard.html"><i class="material-icons">dvr</i> Dashboard</a>
                                        <a class="dropdown-item"
                                           href="mini-profile.html"><i class="material-icons">account_circle</i> My profile</a>
                                        <a class="dropdown-item"
                                           href="mini-edit-account.html"><i class="material-icons">edit</i> Edit account</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item"
                                           href="mini-login.html"><i class="material-icons">exit_to_app</i> Logout</a>
                                    </div>
                                </li>
                            </ul>
              ...
              "datasets": [{"label": "Quotes", "data":[53,17,25,5]}]
                    ...
                    <div class="mdk-drawer  js-mdk-drawer"
                        ...
                        <div class="mdk-drawer__content js-sidebar-mini"
                            ...
                            <div class="sidebar sidebar-mini sidebar-primary sidebar-left"
                                 data-perfect-scrollbar>
                                    ...
                                    <div class="tab-pane fade active show"
                                        ...
                                        <div class="sidebar-block p-0">
                                            <ul class="sidebar-menu">
                                                ...
                                                <li class="sidebar-menu-item">
                                                    <a class="sidebar-menu-button"
                                                       href="mini-ecommerce.html">
                                                        <span class="sidebar-menu-text">E-commerce</span>
                                                    </a>
                                                </li>
                                                <li class="sidebar-menu-item">
                                                    <a class="sidebar-menu-button"
                                                       href="mini-dashboard-quick-access.html">
                                    ...
                                    <div class="tab-pane"
                                        ...
                                        <div class="sidebar-block p-0">
                                            <ul class="sidebar-menu">
                                                <li class="sidebar-menu-item">
                                                    <a class="sidebar-menu-button"
                                                       href="mini-app-activities.html">
                                                        <span class="sidebar-menu-text">Activities</span>
                                                    </a>
                                                </li>
                                                <li class="sidebar-menu-item">
                                                    <a class="sidebar-menu-button"
                                                       href="mini-app-trello.html">
                                                        <span class="sidebar-menu-text">Trello</span>
                                                    </a>
                                                </li>
                                                <li class="sidebar-menu-item">
                                                    <a class="sidebar-menu-button"
                                                       href="mini-app-projects.html">
                                                        <span class="sidebar-menu-text">Projects</span>
                                                    </a>
                                                </li>
                                                <li class="sidebar-menu-item">
                                                    <a class="sidebar-menu-button"
                                                       href="mini-app-fullcalendar.html">
                                                ...
                                                <li class="sidebar-menu-item ">
                                                    ...
                                                    <ul class="sidebar-submenu collapse "
                                                        ...
                                                        <li class="sidebar-menu-item ">
                                                            <a class="sidebar-menu-button"
                                                               href="mini-app-browse-courses.html">
                                                                <span class="sidebar-menu-text">Browse Courses</span>
                                                            </a>
                                                        </li>
                                                        <li class="sidebar-menu-item ">
                                                            <a class="sidebar-menu-button"
                                                               href="mini-app-course.html">
                                                                <span class="sidebar-menu-text">Course</span>
                                                            </a>
                                                        </li>
                                                        <li class="sidebar-menu-item ">
                                                            <a class="sidebar-menu-button"
                                                               href="mini-app-lesson.html">
                                    ...
                                    <div class="tab-pane "
                                        ...
                                        <div class="sidebar-block p-0">
                                            <ul class="sidebar-menu">
                                                ...
                                                <li class="sidebar-menu-item">
                                                    <a class="sidebar-menu-button"
                                                       href="mini-stories.html">
                                                        <span class="sidebar-menu-text">Stories</span>
                                                    </a>
                                                </li>
                                                <li class="sidebar-menu-item">
                                                    <a class="sidebar-menu-button"
                                                       href="mini-discussions.html">
                                                        <span class="sidebar-menu-text">Discussions</span>
                                                    </a>
                                                </li>
                                                <li class="sidebar-menu-item">
                                                    <a class="sidebar-menu-button"
                                                       href="mini-invoice.html">
                                                        <span class="sidebar-menu-text">Invoice</span>
                                                    </a>
                                                </li>
                                                <li class="sidebar-menu-item">
                                                    <a class="sidebar-menu-button"
                                                       href="mini-pricing.html">
                                                ...
                                                <li class="sidebar-menu-item">
                                                    <a class="sidebar-menu-button"
                                                       href="mini-payout.html">
                                                        <span class="sidebar-menu-text">Payout</span>
                                                    </a>
                                                </li>
                                                <li class="sidebar-menu-item">
                                                    <a class="sidebar-menu-button"
                                                       href="mini-digital-product.html">
                                    ...
                                    <div class="tab-pane"
                                        ...
                                        <div class="sidebar-block p-0">
                                            <ul class="sidebar-menu">
                                                ...
                                                <li class="sidebar-menu-item">
                                                    <a class="sidebar-menu-button"
                                                       href="fluid-classes.php">Fluid</a>
                                                </li>
                                                <li class="sidebar-menu-item">
                                                    <a class="sidebar-menu-button"
                                                       href="fixed-classes.php">Fixed</a>
                                                </li>
                                                <li class="sidebar-menu-item active">
                                                    <a class="sidebar-menu-button"
                                                       href="mini-classes.php">Mini</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
